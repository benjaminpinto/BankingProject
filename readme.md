...
Considering this, some test scenarios, mainly those that involves data insertion and deletion, was constructed performing assertions looking to the local storage.
...
| 12  | Depositing a non integer positive amount should not be acceptable as a valid entry                       |   ✍️ No    | 🟢 Passing     |                               -                                |                                                                                                                                                                  -                                                                                                                                                                  |
| 13  | Depositing a negative amount should not be acceptable as a valid entry                                   |   ✍️ No    | 🔴 Not Passing | [#2](https://github.com/benjaminpinto/BankingProject/issues/2) |                                                                           Trying to deposit '-100', no messages are shown, balance doesn't change, but an error is raised at console:`TypeError: Cannot read properties of undefined (reading 'success')`                                                                           |
| 14  | Should not be possible to insert non numeric characters in deposit amount input field                    |   ✍️ No    | 🔴 Not Passing |                               -                                | Typing CTRL+V, its possible to insert non numeric characters, that will be mapped to 'e-'. Surrounding this with valid numbers (ex: 5e-8), the bad data is being stored.<br /><br /> Once this bad data is stored, balance is changed with this value and deposits and withdrawals functionalities no longer works for that account |
...
| 17  | Withdrawal a negative value should not be possible                                                       |   ✍️ No    | 🔴 Not Passing |                               -                                |                                                                                                                                                    Same behavior observed at #13                                                                                                                                                    |
...
| 28  | When click to open an account without properly select a customer and the currency, a validation message should be shown |   🦾 Yes   | 🟢 Passing     |                               -                                |                                    -                                    |
| 29  | Having correctly selected customer and currency, click process should create an account for the selected customer       |   🦾 Yes   | 🟢 Passing     |                               -                                | Checking the alert message and the account persistence at local storage |
